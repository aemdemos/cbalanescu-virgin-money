...
## Environments
- Preview: https://main--cbalanescu-virgin-money--aemdemos.aem.page/
- Live: https://main--cbalanescu-virgin-money--aemdemos.aem.live/
...
1. Open the `cbalanescu-virgin-money` directory in your favorite IDE and start coding :)
